...
public class AccountVerificationControlTest extends BaseDriver {
    ...
    public void Login() {
        ...
        WebElement verifaction= driver.findElement(By.xpath("//a[text()='Senol']"));

        Assert.assertTrue(verifaction.getText().contains("Senol"));
    }
}
